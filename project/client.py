    ...
    for row in range(0, 3):
        ...
        for col in range(0, 9):
            if(platform.system() == 'Darwin'):
                ...
                boxButton = tk.Label(gameWindow, text = random_number(), font=("Chalkboard SE",30), width=3, height=2,borderwidth=5, bg="#fff176")
                boxButton.place(x=xPos, y=yPos)
...
def askPlayerName():
    ...
    canvas1.create_text( screen_width/4.5,screen_height/8, text = "Enter Name", font=("Chalkboard SE",60), fill="Yellow")
    ...
    button = tk.Button(nameWindow, text="Save", font=("Chalkboard SE", 30),width=11, command=saveName, height=2, bg="Black", bd=3)
...
def gameWindow():
    ...
    gameWindow = Tk()
    gameWindow.title("Taklu Tambola")
    ...
    canvas2.create_text( screen_width/4.5,50, text = "Taklu Tambola", font=("Chalkboard SE",50), fill="#3e2723")
